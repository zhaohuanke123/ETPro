            ...
            switch (unitType)
            {
                case UnitType.Player:
                {
                    if (unit.GetComponent<AOIUnitComponent>() == null)
                    {
                        ...
                        // 加入aoi
                        var aoiu = unit.AddComponent<AOIUnitComponent, Vector3, Quaternion, UnitType, int, bool>(unit.Position, unit.Rotation,
                            unit.Type,
                ...
                case UnitType.Skill:
                {
                    if (unit.GetComponent<AOIUnitComponent>() == null)
                    {
                        ...
                        var aoiu = unit.AddComponent<AOIUnitComponent, Vector3, Quaternion, UnitType, bool>(pos, unit.Rotation, unit.Type,
