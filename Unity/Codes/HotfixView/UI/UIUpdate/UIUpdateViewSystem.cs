...
namespace ET
{
	...
	public class UIUpdateViewOnCreateSystem: OnCreateSystem<UIUpdateView>
	{
		public override void OnCreate(UIUpdateView self)
		{
			...
			self.ProgressCircle = self.AddUIComponent<UIProgressCircle>("UIProgressCircle");
			self.TitleText = self.AddUIComponent<UIText>("TitleText");
		}
	}
	...
	public class UIUpdateViewOnEnableSystem: OnEnableSystem<UIUpdateView, Action>
	{
		public override void OnEnable(UIUpdateView self, Action func)
		{
			...
			self.ProgressCircle.SetProcess(0);
	...
	public static class UIUpdateViewSystem
	{
		...
		private static void SetProgress(this UIUpdateView self, float value)
		{
			...
			self.ProgressCircle.SetProcess(self.LastProgress);
		}
		...
		private static void SetTitleText(this UIUpdateView self, string text)
		{
