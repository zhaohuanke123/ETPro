...
namespace ET
{
    ...
    public static class NumericComponentSystem
    {
        ...
        private static int GetType(this NumericComponent self, string key)
        {
            if (NumericType.Map.TryGetValue(key, out var res))
            {
                return res;
            }
        ...
        public static void AddAll(this NumericComponent self, string[] nts, int[] values)
        {
        ...
        public static void Add(this NumericComponent self, int numericType, int numericValue)
        {
            self.Set(numericType, self.GetAsInt(numericType) + numericValue);
        }
